...
from core.utils.regex import extract_doc_number, extract_all_vats, extract_dates, extract_all_oibs
...
def build_auto_annotation_dict(
    ...
    return {
        ...
        "amount_total": str(parsed_data.get("total") or parsed_data.get("iznos") or ""),
